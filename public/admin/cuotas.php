                ...
                <div class="card-body p-4 pmob-0">
                    ...
                    <div class="wizard-content" id="renderform" style="display:none">
                        <form action="#" class="tab-wizard wizard-circle" id="form">
                            ...
                            <input type="hidden" id="idce" idata>
                            <input type="hidden" id="codigo" idata>
                            <!-- Step 1 -->
                            <h6>Info Cuota</h6>
                            <section>
                                <!------------- < Clients> ------------->
                            ...
                            <!-- Step 2 -->
                            <h6>Payment</h6>
                            <section class="payment-method text-center pb-5">
                                <div class="">
                                    <h5 class="fw-semibold fs-5">Procesando pago...</h5>
                                    ...
                                    <div class="flej"><input type="file" class=""></div>
                                </div>

                                <div class="col-lg-12 mt-4 flej">
                                    <div class="col-lg-4 col-12">
                                        <button class="btn mb-1 d-block w-100 btn-outline-success waves-effect waves-light p-2" type="button" style="line-height:25px"
                                            id="buttonPago">
                                            <i class="mdi mdi-account-cash fs-7 me-2" style="vertical-align:text-top"></i>
