<div class="body-wrapper">
    <div class="container-fluid">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="owl-carousel collectibles-carousel owl-theme mt-9">
                            <div class="item">
                                <div class="card overflow-hidden mb-4 mb-md-0 shadow-none border">
                                    <div class="position-relative">
                                        <img src=imgs/1.jpg class="img-fluid w-100" alt="1" />
                                        <div class="card-img-overlay">
                                            <div class="text-end">
                                                <span class="badge bg-dark-subtle rounded-pill fs-2">04h 09m
                                                    12s</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                <div class="card overflow-hidden mb-4 mb-md-0 shadow-none border">
                                    <div class="position-relative">
                                        <img src=imgs/5.jpg class="img-fluid w-100" alt="1" />
                                        <div class="card-img-overlay">
                                            <div class="text-end">
                                                <span class="badge bg-dark-subtle rounded-pill fs-2">02h 10m
                                                    30s</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                <div class="card overflow-hidden mb-4 mb-md-0 shadow-none border">
                                    <div class="position-relative">
                                        <img src=imgs/3.jpg class="img-fluid w-100" alt="1" />
                                        <div class="card-img-overlay">
                                            <div class="text-end">
                                                <span class="badge bg-dark-subtle rounded-pill fs-2">01h 02m
                                                    10s</span>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        ...
                        <div class="card overflow-hidden mt-9">
                            <img src=imgs/my-card.jpg alt="bg-card" height="220">
                            <div class="card-img-overlay text-white">
                                <div class="d-flex align-items-start flex-column h-100">
                                    <div>
                                        <img src=imgs/mastercard.png width="40" alt="mastercard" />
                        ...
                        <div class="card shadow-none mb-0">
                            <div class="card-body p-0">
                                    ...
                                    <div class="ms-auto">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="balance-dd">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="#">
                                                        <i class="ti ti-info-circle me-1 fs-4"></i>Get Info
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <button class="btn bg-primary-subtle text-primary w-100 mt-3"> View Balance
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="#">
                                            <i class="flag-icon flag-icon-in me-1" title="in" id="in"></i>
                                            INR </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="#">
                                            <i class="flag-icon flag-icon-fr me-1" title="fr" id="fr"></i>
                                            FRF </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <table class="table mb-0 align-middle text-nowrap">
                                    ...
                                    <tbody class="text-dark ">
                                        <tr>
                                            <td class="ps-0">
                                                <div class="d-flex align-items-center gap-3 fw-semibold">
                                                    <img src="public/assets/images/profile/user-1.jpg"
                                                        class="rounded-circle" alt="user" width="45" /> Alan
                                                    Walker Origins
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="ps-0">
                                                <div class="d-flex align-items-center gap-3 fw-semibold">
                                                    <img src="public/assets/images/profile/user-2.jpg"
                                                        class="rounded-circle" alt="user" width="45" /> The
                                                    StarSharks NFTs
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="ps-0">
                                                <div class="d-flex align-items-center gap-3 fw-semibold">
                                                    <img src="public/assets/images/profile/user-3.jpg"
                                                        class="rounded-circle" alt="user" width="45" />
                                                    Sacred Realm
                                                </div>
                                            </td>
                                            <td>
            ...
            <div class="col-xl-4 d-flex align-items-strech">
                <div class="card w-100">
                    <img src=public/assets/images/nft/nft-bg.jpg class="card-img" alt="nft" />
                    <div class="p-4 mt-n4 text-center">
                        <div class="position-relative mt-n4">
                            <img src="public/assets/images/profile/user-5.jpg" alt="nft"
                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        ...
                        <div class="card shadow-none mt-3 mb-0">
                            <div class="d-flex align-items-center gap-3 py-3 border-bottom">
                                <img src=imgs/user-5.jpg class="rounded-circle" alt="user" width="40" />
                                <div>
                            ...
                            <div class="d-flex align-items-center gap-3 py-3 border-bottom">
                                <img src=imgs/user-3.jpg class="rounded-circle" alt="user" width="40" />
                                <div>
                            ...
                            <div class="d-flex align-items-center gap-3 py-3">
                                <img src=imgs/user-4.jpg class="rounded-circle" alt="user" width="40" />
                                <div>
                                    ...
                                    <tbody class="text-dark ">
                                        <tr>
                                            <td class="ps-0 text-truncate">
                                                <img src="public/assets/images/profile/user-1.jpg"
                                                    class="rounded img-fluid me-2" width="50" alt="user" />
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="public/assets/images/profile/user-1.jpg"
                                                        width="25" alt="user1" class="rounded-circle" />
                                        ...
                                        <tr>
                                            <td class="ps-0 text-truncate">
                                                <img src="public/assets/images/profile/user-2.jpg"
                                                    class="rounded img-fluid me-2" alt="n1" width="50" />
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <img src="public/assets/images/profile/user-4.jpg"
                                                        width="25" alt="user1" class="rounded-circle" />
                                        ...
                                        <tr>
                                            <td class="ps-0 text-truncate">
                                                <img src="public/assets/images/profile/user-3.jpg"
                                                    class="rounded img-fluid me-2" alt="n2" width="50" />
                                        ...
                                        <tr>
                                            <td class="border-0 ps-0 text-truncate">
                                                <img src="public/assets/images/profile/user-4.jpg"
                                                    class="rounded img-fluid me-2" width="50" alt="n1" />
