<div class="body-wrapper overflow-hidden">
    <section class="hero-section position-relative overflow-hidden mb-0 mb-lg-11">
        <div class="container">
            ...
            <div class="col-xl-6">
                <div class="hero-content my-11 mt-3">
                <h6 class="d-flex align-items-center gap-2 fs-4 fw-semibold mb-3" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000"><i
                    class="ti ti-rocket text-secondary fs-6"></i>Empieza a facturar inmediatamente con:</h6>
                <h1 class="fw-bolder mb-8 fs-13" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">Asistente inteligente & <span class="text-primary"> Automiatizada</span>
                    Facturadora Electrónica</h1>
                <p class="fs-5 mb-5 text-dark fw-normal" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">Facturadora automatizada y autogestionable facturar AHORA.</p>
            ...
            <div class="col-xl-6 d-none d-xl-block">
                ...
                <div class="d-flex flex-row">
                    ...
                    <div class="banner-img-1 slideup">
                        <img src=public/imgs/bannerimg1.svg alt="" class="img-fluid">
                    </div>
                    <div class="banner-img-1 slideup">
                        <img src=public/imgs/bannerimg1.svg alt="" class="img-fluid">
                    </div>
                    ...
                    <div class="banner-img-2 slideDown">
                        <img src=public/imgs/bannerimg2.svg alt="" class="img-fluid">
                    </div>
                    <div class="banner-img-2 slideDown">
                        <img src=public/imgs/bannerimg2.svg alt="" class="img-fluid">
                    </div>
        ...
        <div class="container">
            ...
            <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                ...
                <ul
                    ...
                    <a class="d-block" href="javascript:void(0)">
                        <img src="public/dist/images/profile/user-1.jpg" alt=""
                        class="img-fluid border border-2 rounded-circle border-white" width="32" height="32">
                    </a>
                    </li>
                    <li class="ms-n2">
                    <a class="d-block" href="javascript:void(0)">
                        <img src="public/dist/images/profile/user-2.jpg" alt=""
                        class="img-fluid border border-2 rounded-circle border-white" width="32" height="32">
                    </a>
                    </li>
                    <li class="ms-n2">
                    <a class="d-block" href="javascript:void(0)">
                        <img src="public/dist/images/profile/user-3.jpg" alt=""
                        class="img-fluid border border-2 rounded-circle border-white" width="32" height="32">
                    </a>
                    </li>
                </ul>
            ...
            <div class="demos-view mt-11 pt-lg-8">
                ...
                <div class="col-sm-6 col-lg-4 mb-8">
                    ...
                    <img src=public/imgs/demo-main.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/index.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-lg-4 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/demo-dark.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-lg-4 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/demo-horizontal.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/horizontal/index.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-lg-4 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/demo-minisidebar.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/minisidebar/index.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-lg-4 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/demo-rtl.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/rtl/index.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
            ...
            <div class="demos-view mt-4">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/app-calendar.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/app-calendar.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/app-chat.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/app-chat.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/app-email.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/app-email.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/app-contact.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/app-contact2.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/app-invoice.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/app-invoice.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/modernize-bt-app-contact-list.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/app-contact.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/app-user-profile.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/page-user-profile.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/modernize-vue-app-blog.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/blog-posts.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/modernize-vue-app-blog-detail.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/blog-detail.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/modernize-vue-app-shop.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/eco-shop.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/app-ecommerce-detail.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/eco-shop-detail.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                    <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src=public/imgs/app-ecommerce-list.jpg alt="" class="img-fluid">
                    <a target="_blank" href="../package/html/main/eco-product-list.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                        Preview</a>
                    </div>
    ...
    <section class="bg-light py-5 py-lg-10 py-xl-12">
        <div class="container-fluid">
            ...
            <div class="slide-background d-flex flex-row w-100">
                <div class="slide">
                <img src=public/imgs/slider-group.png alt="slide" height="100%">
                </div>
                <div class="slide">
                <img src=public/imgs/slider-group.png alt="slide" height="100%">
                </div>
                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-between mb-4">
                        ...
                        <ul class="list-unstyled d-flex align-items-center justify-content-end gap-1 mb-0">
                            <li>
                            <a href="">
                                <img src=public/imgs/icon-star.svg alt="" class="img-fluid">
                            </a>
                            </li>
                            <li>
                            <a href="">
    ...
    <section class="bg-primary pt-5 pt-xl-9 pb-8">
        <div class="container">
            ...
            <div class="col-lg-7 col-xl-5 pt-lg-5 mb-5 mb-lg-0">
                <h2 class="fs-12 text-white text-center text-lg-start fw-bolder mb-8">Construye tu solución comercial con el nuevo Smart facturador</h2>
                ...
                <a href="../package/html/main/authentication-register.html" class="btn border-white text-white fw-semibold btn-hover-white d-block">Register</a>
                </div>
            </div>
            <div class="col-lg-5 col-xl-5">
                <div class="text-center text-lg-end">
                <img src="public/dist/images/backgrounds/business-woman-checking-her-mail.png" alt=""
                    class="img-fluid">
                </div>
            </div>
            </div>
