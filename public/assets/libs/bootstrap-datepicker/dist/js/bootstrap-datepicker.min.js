...
!function(a) {
    ...
    k.prototype = {
        ...
        _resolveDaysOfWeek: function(b) {
            return Array.isArray(b) || (b = b.split(/[,\s]*/)),
            a.map(b, Number)
        },
        ...
        setDates: function() {
            ...
            return this.update.apply(this, a),
            this._trigger("changeDate"),
            this.setValue(),
            this
        },
            ...
            if (!this.updating) {
                ...
                if (d !== b) {
                    ...
                    if (-1 !== g) {
                        ...
                        e < this.dates[h])
                            for (; h >= 0 && e < this.dates[h] && (this.pickers[h].element.val() || "").length > 0; )
                                this.pickers[h--].setUTCDate(e);
                        else if (e > this.dates[i])
                            for (; i < j && e > this.dates[i] && (this.pickers[i].element.val() || "").length > 0; )
