...
import { getCreditoType, Status } from '../Types/CreditoType.js';
import {getResource} from '../Services/Creditos.js';
...
export class CreditoView {
    ...
    renderCreditos(creditos: getCreditoType[]): void 
    {
        this.swithView()
    ...
    printCredito(credito: getCreditoType): string
    {
    ...
    displayContent(creditos: getCreditoType[])
    {
        let print = '';
    ...
    viewCredito(credito: getCreditoType): void
    {
